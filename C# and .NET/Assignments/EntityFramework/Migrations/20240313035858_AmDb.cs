...
{
    /// <inheritdoc />
    public partial class AmDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTeam", x => new { x.ProjectListProjectId, x.TeamsTeamId });
                    table.ForeignKey(
                        name: "FK_ProjectTeam_Projects_ProjectListProjectId",
